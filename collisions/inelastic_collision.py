...
class Ball:
    def __init__(self, pos, velo, mass, radius, color, coeff_restitution):
        self.pos = pos
        self.velo = velo
        self.mass = mass
        self.radius = radius
    ...
    def collision(self, other):
        ...
        if distance <= self.radius + other.radius:
            if np.dot(self.velo - other.velo, self.pos - other.pos) < 0: 
                self.velo, other.velo = ((self.mass - self.coeff_restitution * other.mass)*self.velo + (1+self.coeff_restitution)*other.mass * other.velo)/(self.mass + other.mass), ((other.mass- self.coeff_restitution * self.mass)*other.velo+(1+self.coeff_restitution)*self.mass*self.velo)/(self.mass+other.mass)
...
title = font.render("Inelastic Collision", True, "black", "white")
