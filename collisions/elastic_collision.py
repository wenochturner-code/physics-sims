...
class Ball:
    ...
    def collision(self, other):
        ...
        if distance <= self.radius + other.radius:
            self.velo, other.velo = ((self.mass - other.mass)*self.velo + 2*other.mass * other.velo)/(self.mass + other.mass), ((other.mass-self.mass)*other.velo+2*self.mass*self.velo)/(self.mass+other.mass)
...
title = font.render("Elastic Collision", True, "black", "white")
